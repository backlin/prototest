...
import (
	fmt "fmt"
	_2_multiple_files "github.com/backlin/prototest/2_multiple_files"
...
type M3 struct {
	Other *_2_multiple_files.Other `protobuf:"bytes,1,opt,name=other,proto3" json:"other,omitempty"`
}
...
func (m *M3) GetOther() *_2_multiple_files.Other {
	if m != nil {
		return m.Other
	}
	return nil
...
func init() {
	proto.RegisterType((*M3)(nil), "test3.M3")
}
...
var fileDescriptor_ce14422a7e578aae = []byte{
	...
	0x31, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x73, 0xa4, 0x64, 0x8c, 0xe2, 0x73,
	0x4b, 0x73, 0x4a, 0x32, 0x0b, 0x72, 0x52, 0xe3, 0xd3, 0x32, 0x73, 0x52, 0x8b, 0xf5, 0xf3, 0x4b,
	0x32, 0x52, 0x8b, 0x20, 0x8a, 0x94, 0x34, 0xb8, 0x98, 0x7c, 0x8d, 0x85, 0x94, 0xb8, 0x58, 0xc1,
	0x82, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0xdc, 0x46, 0x3c, 0x7a, 0x20, 0xad, 0x46, 0x7a, 0xfe, 0x20,
	0xb1, 0x20, 0x88, 0x94, 0x93, 0xc4, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78,
	0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x24,
	0xb1, 0x81, 0x8d, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x0e, 0x24, 0xda, 0xf7, 0x7e, 0x00,
	0x00, 0x00,
}
...
func (m *M3) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Other == nil {
				m.Other = &_2_multiple_files.Other{}
			}
